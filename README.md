...
Adapted by: Cathleen Wright, Karolin Rafalski, Grant Knief<br>
Competencies: Spectacle, VS Code shortcuts, Command Line & Keyboard shortcuts <br>
...
## Objectives
- Students should be able to utilize shortcuts on the keyboard, Spectacle, terminal, and VS Code
- Students should start building good habits and gain an understanding of how to be a more efficient coder
...
## Part 4 - Visual Studio (VS) Code Setup
